...
GLOBAL_LIST_INIT(footstep, list(
	FOOTSTEP_WOOD = list(list(
		...
		'mojave/sound/ms13effects/footsteps/ms13wood4.ogg'), 40, 0),
	FOOTSTEP_FLOOR = list(list(
		...
		'mojave/sound/ms13effects/footsteps/ms13general4.ogg'), 35, -1),
	...
	FOOTSTEP_ROOF = list(list(
		...
		'mojave/sound/ms13effects/footsteps/ms13roof4.ogg'), 40, 0),
	FOOTSTEP_SNOW = list(list(
		...
		'mojave/sound/ms13effects/footsteps/ms13snow4.ogg'), 40, -1),
	FOOTSTEP_CARPET = list(list(
		'sound/effects/footstep/carpet1.ogg',
		'sound/effects/footstep/carpet2.ogg',
		'sound/effects/footstep/carpet3.ogg',
		'sound/effects/footstep/carpet4.ogg',
		'sound/effects/footstep/carpet5.ogg'), 35, -1),
	FOOTSTEP_SAND = list(list(
		...
		'mojave/sound/ms13effects/footsteps/ms13concrete4.ogg'), 30, 0),
	FOOTSTEP_GRASS = list(list(
		'sound/effects/footstep/grass1.ogg',
		'sound/effects/footstep/grass2.ogg',
		'sound/effects/footstep/grass3.ogg',
		'sound/effects/footstep/grass4.ogg'), 35, 0),
...
GLOBAL_LIST_INIT(barefootstep, list(
	FOOTSTEP_WOOD_BAREFOOT = list(list(
		...
		'sound/effects/footstep/woodbarefoot5.ogg'), 35, -1),
	FOOTSTEP_HARD_BAREFOOT = list(list(
		...
		'sound/effects/footstep/hardbarefoot5.ogg'), 35, -1),
	FOOTSTEP_CARPET_BAREFOOT = list(list(
		...
		'sound/effects/footstep/carpetbarefoot5.ogg'), 35, -2),
	FOOTSTEP_SAND = list(list(
		'sound/effects/footstep/asteroid1.ogg',
		'sound/effects/footstep/asteroid2.ogg',
		'sound/effects/footstep/asteroid3.ogg',
		'sound/effects/footstep/asteroid4.ogg',
		'sound/effects/footstep/asteroid5.ogg'), 35, 0),
	FOOTSTEP_GRASS = list(list(
		'sound/effects/footstep/grass1.ogg',
		'sound/effects/footstep/grass2.ogg',
		'sound/effects/footstep/grass3.ogg',
...
GLOBAL_LIST_INIT(clawfootstep, list(
	FOOTSTEP_WOOD_CLAW = list(list(
		...
		'sound/effects/footstep/woodclaw2.ogg',
		'sound/effects/footstep/woodclaw1.ogg'), 40, 1),
	FOOTSTEP_HARD_CLAW = list(list(
		...
		'sound/effects/footstep/hardclaw1.ogg'), 40, 1),
	FOOTSTEP_CARPET_BAREFOOT = list(list(
		'sound/effects/footstep/carpetbarefoot1.ogg',
		'sound/effects/footstep/carpetbarefoot2.ogg',
		'sound/effects/footstep/carpetbarefoot3.ogg',
		'sound/effects/footstep/carpetbarefoot4.ogg',
		'sound/effects/footstep/carpetbarefoot5.ogg'), 30, -2),
	FOOTSTEP_SAND = list(list(
		'sound/effects/footstep/asteroid1.ogg',
		'sound/effects/footstep/asteroid2.ogg',
		'sound/effects/footstep/asteroid3.ogg',
		'sound/effects/footstep/asteroid4.ogg',
		'sound/effects/footstep/asteroid5.ogg'), 30, 0),
	FOOTSTEP_GRASS = list(list(
		'sound/effects/footstep/grass1.ogg',
		'sound/effects/footstep/grass2.ogg',
		'sound/effects/footstep/grass3.ogg',
		'sound/effects/footstep/grass4.ogg'), 30, 0),
	FOOTSTEP_WATER = list(list(
		'sound/effects/footstep/water1.ogg',
		'sound/effects/footstep/water2.ogg',
		'sound/effects/footstep/water3.ogg',
...
GLOBAL_LIST_INIT(heavyfootstep, list(
	...
	FOOTSTEP_WATER = list(list(
		...
		'sound/effects/footstep/water2.ogg',
		'sound/effects/footstep/water3.ogg',
		'sound/effects/footstep/water4.ogg'), 50, 2),
	FOOTSTEP_LAVA = list(list(
		'sound/effects/footstep/lava1.ogg',
		'sound/effects/footstep/lava2.ogg',
		'sound/effects/footstep/lava3.ogg'), 50, 0),
